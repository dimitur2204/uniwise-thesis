  ...
  return (
    <>
      <div onClick={toggleOpen}>
        <ToolbarIcon className={className}><img src={Notes} alt='notes' /></ToolbarIcon>
      </div>
      <div
        className={`notepad ${isOpen ? "" : "hidden"} ${
      ...
      />
      <div
        className={`notepad-character-count ${
          isMaxCharacters ? "max-characters" : ""
        }`}
      >
        {characterCount}/1000
      </div>
